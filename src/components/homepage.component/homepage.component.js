    ...
    <div className="home-main">
      ...
      <div className="home-drop hide-on-med-and-down">
        <div className="home-drop-eco" >
          ...
          <ul id="drop-eco" className="dropdown-content drop-eco-down center-align">
            <li className="center-align" onClick={() => setEcon("Economy")}>Economy</li>
            <li className="center-align" onClick={() => setEcon("Premium Economy")}>Premium Economy</li>
            <li className="center-align" onClick={() => setEcon("Business")}>Business</li>
            <li className="center-align" onClick={() => setEcon("First")}>First</li>
          </ul>
        </div>
      ...
      <div className="home-content">
        ...
        <div className="home-search-passengers">
          ...
          <div className="modal" id="modal-pas">
