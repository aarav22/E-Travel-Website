                ...
                <div className="flight-card" key={flight.id}>
                  <div className="flight-card-details">
                    <div className="airline-details">
                      ...
                      <p className="airline-name">{flight.aircraftCompany}</p>
                    </div>

                    <div className="flight-details">
                      <div className="flight-rating">{flight.rating}</div>
                      <div className="flight-timings">
                        <span className="flight-timing-dep">{flight.departureTime}</span>
                        <span className="line"></span>
                        <span className="flight-timing-arr">{flight.arrivalTime}</span>
                      </div>
                  ...
                  <div className="flight-card-price">
                    <div className="flight-rating">{flight.price}</div>
                  </div>
                </div>
              )
            })
